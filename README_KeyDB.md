...
* Исходный код KeyDB доступен на GitHub ([github.com/EQ-Alpha/KeyDB](https://github.com/Snapchat/KeyDB)), где также можно найти дополнительную документацию и примеры использования. 
